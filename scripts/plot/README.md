...
The commonly used functions are defined in [fluxsr/utils/plot_util.py](https://github.com/XPixelGroup/BasicSR/blob/plot/fluxsr/utils/plot_util.py), such as `read_data_from_tensorboard`, `smooth_data`, `read_data_from_txt_2v`, *etc*.
