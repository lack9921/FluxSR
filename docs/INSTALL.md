...
&emsp;deformable convolution: [*dcn* for EDVR](fluxsr/ops) (For torchvision>=0.9.0, we use the official `torchvision.ops.deform_conv2d` instead)<br>
&emsp;StyleGAN customized operators: [*upfirdn2d* and *fused_act* for StyleGAN2](fluxsr/ops)<br>
you also need to:
