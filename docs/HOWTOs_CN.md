...
1. 使用分布式训练. 更多训练命令: [TrainTest_CN.md](TrainTest_CN.md)
    ...
    > python -m torch.distributed.launch --nproc_per_node=8 --master_port=4321 fluxsr/train.py -opt options/train/StyleGAN/train_StyleGAN2_256_Cmul2_FFHQ.yml --launcher pytorch
