...
1. Train with distributed training. More training commands are in [TrainTest.md](TrainTest.md).
    ...
    > python -m torch.distributed.launch --nproc_per_node=8 --master_port=4321 fluxsr/train.py -opt options/train/StyleGAN/train_StyleGAN2_256_Cmul2_FFHQ_800k.yml --launcher pytorch
...
1. Train with distributed training. More training commands are in [TrainTest.md](TrainTest.md).
    ...
    > python -m torch.distributed.launch --nproc_per_node=8 --master_port=4331 fluxsr/train.py -opt options/train/SwinIR/train_SwinIR_SRx4_scratch.yml --launcher pytorch  --auto_resume
